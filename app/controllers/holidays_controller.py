...
class HolidayController:
    ...
    def create(self, data):
        try:
            ...
            db.session.commit()
            return {
                'message': f'El feriado {data["date"]} se creo con exito'
            }, 201
    ...
    def Update(self, id, data):
        try:
            ...
            if record:
                ...
                db.session.commit()
                return {
                    'message': f'El feriado {id}, ha sido actualizado'
                }, 200
            return {
    ...
    def Delete(self, id):
        try:
            ...
            if record and record.status:
                ...
                db.session.commit()
                return {
                    'message': f'El feriado {id}, ha sido deshabilitado'
                }, 200
            return {
                'message': 'No se encontro el feriado mencionado'
            }, 404
    ...
    def deliveryDate(self):
        print(self.datetimenow , self.hournow)
        return {},200